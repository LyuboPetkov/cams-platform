...
#  added in Phase 15, plus Phase 16's async embedding pipeline: pgvector
...
#  the new embedding-service HTTP microservice)
#
...
#        set -a; source .env; set +a
#        bash scripts/smoke-test-phase16.sh
#
...
echo "CAMS Phase 15 smoke test  ($API, run $RUN)"
echo
