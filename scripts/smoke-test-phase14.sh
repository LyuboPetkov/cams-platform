...
#  apply flow and its auto-created linked JobApplication added in Phase 14)
#
...
#        set -a; source .env; set +a
#        bash scripts/smoke-test-phase14.sh
#
...
echo "CAMS Phase 14 smoke test  ($API, run $RUN)"
echo
